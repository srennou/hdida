...
public class NetworkConnection {
    ...
    public static final String ERR_DIALOG_TITLE = "Aucune connection internet detecter !";
    private static final String ERR_DIALOG_MSG = "Notre application na pas pu detecter une connection internet actif, " +
            "veillez verifier votre parametres de connection.";
    private static final String ERR_DIALOG_POSITIVE_BTN = "Parametre";
